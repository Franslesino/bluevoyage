            ...
            <main className="w-full bg-background text-foreground overflow-x-hidden selection:bg-[#CB9275] selection:text-white pb-24 md:pb-0">
                ...
                <section className="relative h-[100vh] w-full flex items-center justify-center overflow-hidden">
                    ...
                    <div className="relative z-10 container mx-auto px-6 md:px-12 text-center text-white max-w-5xl">
                        ...
                        <h1 className="font-canto text-6xl md:text-7xl lg:text-9xl mb-8 leading-[0.95] drop-shadow-2xl tracking-tight">
                            Custom Voyage
                        </h1>

                        <span className="inline-block px-8 py-3 rounded-full border border-[#CB9275]/20 bg-[#FDF8F6]/10 backdrop-blur-sm mb-8">
                        ...
                        <div className="flex flex-col md:flex-row gap-5 justify-center items-center mb-10">
                            <button
                                ...
                                className="group px-10 py-5 bg-[#CB9275] hover:bg-[#B67F63] text-white font-avenir tracking-[0.15em] uppercase text-sm transition-all duration-300 w-full md:w-auto min-w-[280px] shadow-2xl hover:shadow-[#CB9275]/30"
                            >
                            ...
                            <a
                                ...
                                className="group px-10 py-5 border-2 border-white/90 text-white hover:bg-white/10 hover:border-white font-avenir tracking-[0.15em] uppercase text-sm transition-all duration-300 w-full md:w-auto min-w-[280px] backdrop-blur-sm text-center"
                            >
                        ...
                        {/* Trust micro-row */}
                        <div className="flex flex-col md:flex-row gap-6 md:gap-8 justify-center items-center text-white/80 text-sm font-avenir">
                ...
                <section className="py-32 bg-background relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 max-w-7xl relative z-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 md:gap-16 max-w-6xl mx-auto mb-16">
                            ...
                            >
                                <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[#CB9275]/10 flex items-center justify-center">
                                    <span className="font-canto text-3xl text-[#CB9275]">1</span>
                                </div>
                                <h3 className="font-canto text-3xl text-foreground mb-4">Tell us your vibe</h3>
                            ...
                            >
                                <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[#CB9275]/10 flex items-center justify-center">
                                    <span className="font-canto text-3xl text-[#CB9275]">2</span>
                                </div>
                                <h3 className="font-canto text-3xl text-foreground mb-4">We design the route</h3>
                                <p className="font-avenir text-foreground/70 leading-relaxed">
                            ...
                            >
                                <div className="w-16 h-16 mx-auto mb-6 rounded-full bg-[#CB9275]/10 flex items-center justify-center">
                                    <span className="font-canto text-3xl text-[#CB9275]">3</span>
                                </div>
                                <h3 className="font-canto text-3xl text-foreground mb-4">You approve + refine</h3>
                                <p className="font-avenir text-foreground/70 leading-relaxed">
                        ...
                        <p className="text-center font-avenir text-foreground/60 italic text-lg max-w-2xl mx-auto">
                            We'll guide you—no overwhelm, just clarity.
                        </p>
                    </div>
                </section>

                {/* PHASE 3: DESTINATIONS SECTION (Reuse from Home) */}
                <section className="py-32 bg-[#FAFAFA]">
                    <div className="container mx-auto px-6 max-w-7xl">
                        <div className="text-center mb-20">
                            ...
                            <p className="font-avenir text-foreground/60 text-lg max-w-3xl mx-auto">
                ...
                {/* PHASE 4: ACTIVITIES SECTION (Reuse from Home) */}
                ...
                {/* PHASE 5: CONCIERGE FORM */}
                <section id="concierge-form" className="py-32 bg-[#FAFAFA] relative scroll-mt-24">
                    {/* Background texture */}
                    ...
                    <div className="container mx-auto px-6 max-w-4xl relative z-10">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="font-canto text-5xl md:text-6xl text-foreground mb-6">
                                We'll craft your Custom Voyage.
                            </h2>
                            <p className="font-avenir text-foreground/70 text-lg leading-relaxed max-w-2xl mx-auto">
                        ...
                        <div className="bg-white p-8 md:p-12 shadow-xl">
                            <div className="space-y-6">
                                {/* Name */}
                                <div>
                                    <label className="block font-avenir text-sm font-bold text-foreground/80 mb-2 uppercase tracking-wide">
                                        Your Name
                                    </label>
                                    <input
                                        type="text"
                                ...
                                {/* Interests */}
                                <div>
                                    <label className="block font-avenir text-sm font-bold text-foreground/80 mb-3 uppercase tracking-wide">
                                        Your Interests
                                    </label>
                                    <div className="flex flex-wrap gap-3">
                                        {interestOptions.map((interest) => (
                                            <button
                                                ...
                                                className={`px-5 py-2 rounded-full font-avenir text-sm transition-all ${formData.interests.includes(interest)
                                    ...
                                    <div className="grid grid-cols-3 gap-4">
                                        {["Unhurried", "Balanced", "Expedition"].map((pace) => (
                                            <button
                                                ...
                                                className={`px-5 py-3 font-avenir text-sm transition-all ${formData.pace === pace
                                                        ? "bg-[#CB9275] text-white shadow-md"
                                                        : "bg-white border border-foreground/20 text-foreground hover:border-[#CB9275]"
                                                    }`}
                                            >
...
Looking forward to hearing from you!`)}`}
                    ...
                    <div className="container mx-auto px-6 max-w-5xl">
                        <div className="text-center space-y-12">
                            <div>
                                ...
                                <blockquote className="font-canto text-4xl md:text-5xl leading-tight mb-8 italic">
                                    "We told them what we loved—quiet reefs and slow mornings—and they built a route that felt made for us."
                                </blockquote>
                                <p className="font-avenir text-[#CB9275] uppercase tracking-[0.2em] text-sm">
                                    — Couple, Jakarta
                                </p>
                            </div>

                            <div className="border-t border-background/20 pt-12">
                                <blockquote className="font-canto text-3xl md:text-4xl leading-tight mb-8 italic">
                ...
                <section className="py-32 bg-background">
                    <div className="container mx-auto px-6 max-w-4xl">
                        <div className="text-center mb-20">
                            ...
                            <h2 className="font-canto text-5xl md:text-6xl text-foreground">
                ...
                {/* PHASE 8: FINAL CTA */}
                <section className="py-32 bg-gradient-to-br from-foreground via-foreground to-foreground/95 text-background relative overflow-hidden">
                    ...
                    <div className="container mx-auto px-6 max-w-4xl text-center relative z-10">
                        <h2 className="font-canto text-5xl md:text-7xl mb-8 leading-tight">
                            Your islands. Your pace. Your voyage.
                        </h2>
                        <p className="font-avenir text-xl text-background/80 mb-12 max-w-2xl mx-auto leading-relaxed">
                        ...
                        <div className="flex flex-col md:flex-row gap-5 justify-center items-center">
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noopener noreferrer"
                                className="group px-10 py-5 border-2 border-background/90 text-background hover:bg-background/10 hover:border-background font-avenir tracking-[0.15em] uppercase text-sm transition-all duration-300 w-full md:w-auto min-w-[280px] backdrop-blur-sm text-center"
                            >
                                <span className="inline-block group-hover:scale-105 transition-transform duration-300">Chat on WhatsApp</span>
                            </a>
                        </div>
