            ...
            <main className="min-h-screen bg-[#F8F5F2] text-[#1A1A1A]">
                ...
                <section className="relative h-screen min-h-[600px] w-full flex items-center justify-center overflow-hidden">
                    <div className="absolute z-50 top-24 left-4 md:left-8">
                        <BackLink href="/destinations" label={t.destinationDetail?.backToDestinations || "Back to Destinations"} variant="light" />
                    </div>
                ...
                <div className="max-w-7xl mx-auto px-5 md:px-10 py-16 md:py-24 space-y-24 md:space-y-32">
                    ...
                    <section>
                        <div className="flex flex-col md:flex-row items-baseline justify-between mb-12 border-b border-gray-200 pb-4">
                            <h2 className="font-canto text-3xl md:text-5xl text-[#2C3E50]">{t.destinationDetail?.signatureExperiences || "Signature Experiences"}</h2>
                            <div className="font-avenir text-sm uppercase tracking-widest text-gray-500 mt-2 md:mt-0">
                                {t.destinationDetail?.curatedFor || "Curated for"} {destination.name}
                            </div>
                        </div>
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-12">
                        <div className="space-y-3">
                            ...
                            <p className="font-avenir text-xs uppercase tracking-widest text-gray-500 text-center">
                                {t.destinationDetail?.textureDetail || "Texture & Detail"}
                            </p>
                        </div>
                        <div className="space-y-3 md:pt-16">
                            ...
                            <p className="font-avenir text-xs uppercase tracking-widest text-gray-500 text-center">
                                {t.destinationDetail?.atmosphereMood || "Atmosphere & Mood"}
                            </p>
                        </div>
                    </section>
                    ...
                    <section className="grid grid-cols-1 md:grid-cols-12 gap-12 bg-white p-8 md:p-12 border border-blue-50/50 shadow-sm">
                        ...
                        <div className="md:col-span-7 space-y-8">
                            <h2 className="font-canto text-3xl md:text-4xl text-[#2C3E50]">{t.destinationDetail?.routePlanning || "Route Planning"}</h2>
                            ...
                            <div>
                                <span className="font-avenir text-xs uppercase text-gray-400 tracking-wider block mb-2">{t.destinationDetail?.pairsWellWith || "Pairs well with"}</span>
                ...
                <section className="bg-[#111827] text-white py-20 px-5 text-center">
                    <div className="max-w-2xl mx-auto space-y-8">
                        <h2 className="font-canto text-4xl md:text-5xl">{t.destinationDetail?.makeItPartOfRoute || "Make it part of your route"}</h2>
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            ...
                            >
                                {t.destinationDetail?.seeAllDestinations || "See all destinations"}
                            </LocaleLink>
                        </div>
                    </div>
                </section>
