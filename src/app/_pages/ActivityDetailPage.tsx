                    ...
                    <div className="bg-white p-8 md:p-16 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-20 max-w-4xl mx-auto">
                            <div className="space-y-4">
                                <h3 className="font-canto text-2xl md:text-3xl text-[#6b4c3b]">{overviewLabel}</h3>
                                <p className="font-avenir text-neutral-600 leading-relaxed">
                                    {programOverview}
                                </p>
                            </div>
                            <div className="space-y-4">
                                <h3 className="font-canto text-2xl md:text-3xl text-[#6b4c3b]">{whatYoullDoLabel}</h3>
                                <p className="font-avenir text-neutral-600 leading-relaxed">
                                    {programWhatYoullDo}
                                </p>
                            </div>
                            <div className="space-y-4">
                                <h3 className="font-canto text-2xl md:text-3xl text-[#6b4c3b]">{bestTimeLabel}</h3>
                                <p className="font-avenir text-neutral-600 leading-relaxed">
                                    {programBestTime}
                                </p>
                            </div>
                            <div className="space-y-4">
                                <h3 className="font-canto text-2xl md:text-3xl text-[#6b4c3b]">{notesLabel}</h3>
                                <p className="font-avenir text-neutral-600 leading-relaxed">
                                    {programNotes}
                                </p>
                            </div>
