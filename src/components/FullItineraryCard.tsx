                ...
                <div className="relative z-10 flex flex-col items-center">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 w-full justify-center">
                        <a
                            ...
                            className="flex-1 max-w-full md:max-w-xs px-6 py-4 bg-[#CB9275] hover:bg-[#B67F63] text-white font-avenir tracking-widest uppercase text-xs md:text-sm transition-all duration-300 shadow-md hover:shadow-lg rounded-sm text-center flex items-center justify-center gap-2"
                        >
                        ...
                        <a
                            href={emailHref}
                            className="flex-1 max-w-full md:max-w-xs px-6 py-4 border border-foreground/20 hover:border-[#CB9275] text-foreground hover:text-[#CB9275] font-avenir tracking-widest uppercase text-xs md:text-sm transition-all duration-300 rounded-sm text-center flex items-center justify-center gap-2"
                        >
